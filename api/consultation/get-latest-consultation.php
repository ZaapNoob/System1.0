...
try {
    ...
    foreach ($consultations as $row) {
        $formattedConsultations[] = [
            ...
            'receiving_personnel' => $row['receiving_personnel'],
            'referral_category' => $row['referral_category'],
            'reason_for_referral_2' => $row['reason_for_referral_2'],
            'identity_number_manual' => $row['identity_number_manual'],
